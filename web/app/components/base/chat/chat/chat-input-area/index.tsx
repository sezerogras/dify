...
const ChatInputArea = ({
  ...
  return (
    <>
      <div
        className={cn(
          "relative z-10 rounded-xl border border-components-chat-input-border bg-white pb-[9px]",
          isDragActive &&
          ...
          <div ref={wrapperRef} className="flex items-center justify-between">
            <div className="relative flex w-full grow items-center">
              ...
              <Textarea
                ...
                className={cn(
                  "body-lg-regular w-full resize-none bg-transparent p-1 leading-6 text-black outline-none"
                )}
