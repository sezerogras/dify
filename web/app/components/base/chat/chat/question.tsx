...
const Question: FC<QuestionProps> = ({
  ...
  const handleSwitchSibling = useCallback(
    (direction: "prev" | "next") => {
      ...
      else item.nextSibling && switchSibling?.(item.nextSibling);
    },
  ...
  return (
    <div className="mb-2 flex justify-end last:mb-0">
      <div
        className={cn(
          "group relative mr-4 flex max-w-full items-start pl-14",
          isEditing && "flex-1"
        )}
      >
        ...
        <div
          ref={contentRef}
          className="w-full rounded-2xl bg-[#D98F46] px-4 py-3 text-sm text-gray-900 backdrop-blur-lg"
