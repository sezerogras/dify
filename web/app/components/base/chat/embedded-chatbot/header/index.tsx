...
const Header: FC<IHeaderProps> = ({
          ...
          <div className="shrink-0">
            {!appData?.custom_config?.remove_webapp_brand && (
              <div className={cn("flex shrink-0 items-center gap-1.5 px-2")}>
                ...
                <div className="system-1xs-medium-uppercase text-text-tertiary text-[8px]">
  ...
  return (
    <div
      className={cn(
        "flex h-14 shrink-0 items-center justify-between rounded-t-2xl px-3 bg-[#f8e71c]"
      )}
      //   style={Object.assign(
      //     {},
    ...
    >
      <div className="flex grow items-center space-x-3">
        {customerIcon}
        <div
          className="system-md-semibold truncate text-black"
