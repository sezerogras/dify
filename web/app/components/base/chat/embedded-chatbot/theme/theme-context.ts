...
export class Theme {
  ...
  public primaryColor = "#f8e71c";
  public backgroundHeaderColorStyle =
  ...
  private configCustomColor() {
    if (this.chatColorTheme !== null && this.chatColorTheme !== "") {
      this.primaryColor = this.chatColorTheme ?? "#f8e71c";
      ...
      this.roundedBackgroundColorStyle = `backgroundColor: ${hexToRGBA(
        this.primaryColor,
        0.05
      )}`;
      this.chatBubbleColorStyle = `backgroundColor: ${hexToRGBA(
        this.primaryColor,
        0.15
      )}`;
