...
const ChatWrapper = () => {
  ...
  const messageList = useMemo(() => {
    if (currentConversationId) return chatList;
  ...
  const welcome = useMemo(() => {
        ...
        <div className="flex min-h-[50vh] items-center justify-center px-4 py-12">
          <div className="flex max-w-[720px] grow gap-4">
            ...
            <div className="w-0 grow">
              <div className="body-lg-regular grow rounded-2xl bg-[#D98F46] backdrop-blur-bg px-4 py-3 text-text-primary">
    ...
    return (
      <div
        className={cn(
          "flex h-[50vh] flex-col items-center justify-center gap-3 py-12"
        )}
      >
        <AppIcon
          size="xl"
  ...
  return (
    <div className="h-full overflow-hidden">
      <Chat
        ...
        isResponding={respondingState}
        chatContainerInnerClassName={`mx-auto pt-6 w-full max-w-[768px] ${
          isMobile && "px-4"
        }`}
        chatFooterClassName="pb-4"
        chatFooterInnerClassName={`mx-auto w-full max-w-[768px] ${
          isMobile ? "px-2" : "px-4"
        }`}
        onSend={doSend}
        inputs={
