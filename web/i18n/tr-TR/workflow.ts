const translation = {
  common: {
    ...
    workflowProcess: "Düşünme Süreci",
    notRunning: "Henüz çalıştırılmadı",
    previewPlaceholder:
      "Sohbet Robotunu hata ayıklamak için aşağıdaki kutuya içerik girin",
    effectVarConfirm: {
      title: "Değişkeni Kaldır",
      content:
        "Değişken diğer düğümlerde kullanılıyor. Yine de kaldırmak istiyor musunuz?",
    },
    ...
    workflowAsToolTip:
      "Workflow güncellemesinden sonra araç yeniden yapılandırması gereklidir.",
    ...
    importDSLTip:
      "Geçerli taslak üzerine yazılacak. İçe aktarmadan önce workflow yedekleyin.",
    ...
    ImageUploadLegacyTip:
      "Artık başlangıç formunda dosya türü değişkenleri oluşturabilirsiniz. Gelecekte resim yükleme özelliğini artık desteklemeyeceğiz.",
  ...
  env: {
    ...
    envDescription:
      "Çevre değişkenleri özel bilgileri ve kimlik bilgilerini saklamak için kullanılabilir. Yalnızca okunabilirler ve dışa aktarım sırasında DSL dosyasından ayrılabilirler.",
    ...
    modal: {
      ...
      secretTip:
        "Hassas bilgileri veya verileri tanımlamak için kullanılır, bilgi sızıntısını önlemek için DSL ayarları yapılandırılmıştır.",
    },
    export: {
  ...
  chatVariable: {
    ...
    panelDescription:
      "Konuşma Değişkenleri, LLM'nin hatırlaması gereken interaktif bilgileri (konuşma geçmişi, yüklenen dosyalar, kullanıcı tercihleri dahil) depolamak için kullanılır. Bunlar okunabilir ve yazılabilirdir.",
  ...
  changeHistory: {
    ...
    hint: "İpucu",
    hintText:
      "Düzenleme işlemleriniz, bu oturum süresince cihazınızda saklanan bir değişiklik geçmişinde izlenir. Bu tarihçesi düzenleyiciden çıktığınızda temizlenir.",
  ...
  errorMsg: {
    ...
    rerankModelRequired:
      "Yeniden Sıralama Modelini açmadan önce, lütfen ayarlarda modelin başarıyla yapılandırıldığını onaylayın.",
  ...
  blocksAbout: {
    ...
    "knowledge-retrieval":
      "Kullanıcı sorularıyla ilgili metin içeriğini Bilgi'den sorgulamanıza olanak tanır",
    "question-classifier":
      "Kullanıcı sorularının sınıflandırma koşullarını tanımlayın, LLM sınıflandırma açıklamasına dayalı olarak konuşmanın nasıl ilerleyeceğini tanımlayabilir",
    ...
    "template-transform":
      "Jinja şablon sözdizimini kullanarak verileri stringe dönüştürün",
    "http-request":
      "HTTP protokolü üzerinden sunucu isteklerinin gönderilmesine izin verin",
    "variable-assigner":
      "Çoklu dal değişkenlerini tek bir değişkende toplayın ve sonraki düğümler için birleşik bir yapılandırma sağlayın.",
    assigner:
      "Değişken atama düğümü, yazılabilir değişkenlere (konuşma değişkenleri gibi) değer atamak için kullanılır.",
    "variable-aggregator":
      "Çoklu dal değişkenlerini tek bir değişkende toplayın ve sonraki düğümler için birleşik bir yapılandırma sağlayın.",
    iteration:
      "Bir liste nesnesinde birden fazla adım gerçekleştirir ve tüm sonuçlar çıkana kadar devam eder.",
    "parameter-extractor":
      "Aracı çağırmak veya HTTP istekleri için doğal dilden yapılandırılmış parametreler çıkarmak için LLM kullanın.",
    "document-extractor":
      "Yüklenen belgeleri LLM tarafından kolayca anlaşılabilen metin içeriğine ayrıştırmak için kullanılır.",
    "list-operator":
      "Dizi içeriğini filtrelemek veya sıralamak için kullanılır.",
    agent:
      "Soruları yanıtlamak veya doğal dili işlemek için büyük dil modellerini çağırma",
    loop: "Sonlandırma koşulu karşılanana kadar veya maksimum döngü sayısına ulaşılana kadar bir mantık döngüsü çalıştırın.",
    "loop-end":
      '"break" ile eşdeğerdir. Bu düğümün yapılandırma öğesi yoktur. Döngü gövdesi bu düğüme ulaştığında, döngü sona erer.',
  },
  operator: {
    zoomIn: "Yakınlaştır",
    zoomOut: "Uzaklaştır",
  ...
  nodes: {
    common: {
      ...
      errorHandle: {
        ...
        failBranch: {
          ...
          inLog:
            "Düğüm özel durumu, başarısız dalı otomatik olarak yürütür. Düğüm çıkışı bir hata türü ve hata mesajı döndürür ve bunları aşağı akışa iletir.",
          customizeTip:
            "Başarısız dal etkinleştirildiğinde, düğümler tarafından oluşturulan özel durumlar işlemi sonlandırmaz. Bunun yerine, önceden tanımlanmış hata dalını otomatik olarak yürüterek hata mesajları, raporlar, düzeltmeler veya atlama eylemleri sağlamanıza olanak tanır.",
        },
        partialSucceeded: {
    ...
    llm: {
      ...
      notSetContextInPromptTip:
        "Bağlam özelliğini etkinleştirmek için lütfen PROMPT içinde bağlam değişkenini doldurun.",
      prompt: "prompt",
      roleDescription: {
      ...
      jsonSchema: {
        warningTips: {
          saveSchema:
            "Lütfen şemayı kaydetmeden önce mevcut alanı düzenlemeyi tamamlayın.",
        },
        apply: "Uygula",
        addField: "Alan Ekle",
        ...
        instruction: "Talimat",
        promptTooltip:
          "Metin tanımını standart bir JSON Şeması yapısına dönüştür.",
        ...
        generationTip:
          "Doğal dil kullanarak hızlıca bir JSON Şeması oluşturabilirsiniz.",
        addChildField: "Çocuk Alanı Ekle",
        resultTip:
          "İşte oluşturulan sonuç. Eğer memnun değilseniz, geri dönüp isteminizi değiştirebilirsiniz.",
      },
    },
    knowledgeRetrieval: {
      ...
      metadata: {
        options: {
          ...
          automatic: {
            ...
            subTitle:
              "Kullanıcı sorgusuna dayalı olarak otomatik olarak meta veri filtreleme koşulları oluşturun.",
          },
          manual: {
    ...
    http: {
      ...
      extractListPlaceholder:
        "Liste öğesi dizinini girin, '/' yazın değişken ekle",
      curl: {
    ...
    code: {
      ...
      advancedDependenciesTip:
        "Burada daha uzun sürede tüketilen veya varsayılan olarak yerleşik olmayan bazı ön yüklenmiş bağımlılıkları ekleyin",
    ...
    ifElse: {
      ...
      elseDescription:
        "Eğer koşulu karşılanmadığında hangi mantığın çalıştırılması gerektiğini tanımlamak için kullanılır.",
      and: "ve",
      or: "veya",
      operator: "Operatör",
    ...
    variableAssigner: {
      ...
      aggregationGroupTip:
        "Bu özelliği etkinleştirmek, değişken toplayıcının birden fazla değişken setini toplamasına olanak tanır.",
      addGroup: "Grup Ekle",
      outputVars: {
    ...
    assigner: {
      ...
      writeModeTip:
        "ATANAN DEĞİŞKEN bir dizi olduğunda, ekleme modu sona ekler.",
      ...
      assignedVarsDescription:
        "Atanan değişkenler, konuşma değişkenleri gibi yazılabilir değişkenler olmalıdır.",
    ...
    tool: {
      ...
      outputVars: {
        ...
        files: {
          ...
          transfer_method:
            "Transfer yöntemi. Değer remote_url veya local_file olabilir",
          url: "Resim URL'si",
    ...
    questionClassifiers: {
      ...
      instruction: "Talimat",
      instructionTip:
        "Soru sınıflandırıcının soruları nasıl kategorize edeceğini daha iyi anlamasına yardımcı olmak için ek talimatlar girin.",
    ...
    parameterExtractor: {
      ...
      addExtractParameterContent: {
        ...
        required: "Gerekli",
        requiredContent:
          "Gerekli sadece model çıkarımı için referans olarak kullanılır ve parametre çıktısının zorunlu doğrulaması için kullanılmaz.",
      },
      extractParametersNotSet: "Çıkarma Parametreleri ayarlanmadı",
      instruction: "Talimat",
      instructionTip:
        "Parametre çıkarıcının parametreleri nasıl çıkaracağını anlamasına yardımcı olmak için ek talimatlar girin.",
      advancedSetting: "Gelişmiş Ayarlar",
      reasoningMode: "Akıl Yürütme Modu",
      reasoningModeTip:
        "Modelin fonksiyon çağırma veya istemler için talimatlara yanıt verme yeteneğine bağlı olarak uygun akıl yürütme modunu seçebilirsiniz.",
      isSuccess:
        "Başarılı mı. Başarılı olduğunda değer 1, başarısız olduğunda değer 0'dır.",
    ...
    iteration: {
      ...
      parallelPanelDesc:
        "Paralel modda, yinelemedeki görevler paralel yürütmeyi destekler.",
      answerNodeWarningDesc:
        "Paralel mod uyarısı: Yinelemeler içindeki yanıt düğümleri, konuşma değişkeni atamaları ve kalıcı okuma/yazma işlemleri özel durumlara neden olabilir.",
      parallelModeEnableDesc:
        "Paralel modda, yinelemeler içindeki görevler paralel yürütmeyi destekler. Bunu sağdaki özellikler panelinde yapılandırabilirsiniz.",
      MaxParallelismDesc:
        "Maksimum paralellik, tek bir yinelemede aynı anda yürütülen görevlerin sayısını kontrol etmek için kullanılır.",
    },
    note: {
      addNote: "Not Ekle",
      editor: {
    ...
    agent: {
      strategy: {
        ...
        configureTipDesc:
          "Aracı stratejiyi yapılandırdıktan sonra, bu düğüm kalan yapılandırmaları otomatik olarak yükleyecektir. Strateji, çok adımlı araç akıl yürütme mekanizmasını etkileyecektir.",
        shortLabel: "Strateji",
        tooltip:
          "Farklı Agentic stratejileri, sistemin çok adımlı araç çağrılarını nasıl planladığını ve yürüttüğünü belirler",
      },
      pluginInstaller: {
        install: "Yüklemek",
        installing: "Yükleme",
      ...
      modelNotSupport: {
        descForVersionSwitch:
          "Yüklenen eklenti sürümü bu modeli sağlamaz. Sürümü değiştirmek için tıklayın.",
      ...
      pluginNotFoundDesc:
        "Bu eklenti GitHub'dan yüklenmiştir. Lütfen şuraya gidin: Eklentiler yeniden yüklemek için",
      strategyNotFoundDescAndSwitchVersion:
        "Yüklenen eklenti sürümü bu stratejiyi sağlamaz. Sürümü değiştirmek için tıklayın.",
    ...
    loop: {
      ...
      exitConditionTip:
        "Bir döngü düğümünün en az bir çıkış koşuluna ihtiyacı vardır.",
      ...
      loopMaxCountError:
        "Lütfen 1 ile {{maxCount}} arasında geçerli bir maksimum döngü sayısı girin.",
      variableName: "Değişken Adı",
      deleteDesc: "Döngü düğümünü silmek, tüm alt düğümleri kaldıracaktır.",
      breakConditionTip:
        "Sadece sonlandırma koşulları olan döngüler içindeki değişkenler ve konuşma değişkenleri referans alınabilir.",
  ...
  variableReference: {
    assignedVarsDescription:
      "Atanan değişkenler, örneğin yazılabilir değişkenler olmalıdır",
  ...
  versionHistory: {
    ...
    restorationTip:
      "Sürüm geri yüklemeden sonra, mevcut taslak üzerine yazılacak.",
    title: "Sürümler",
