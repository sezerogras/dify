const translation = {
  ...
  chat: {
    ...
    poweredBy: "Biletinial Tarafından desteklenmektedir",
    prompt: "Prompt",
  ...
  generation: {
    ...
    savedNoData: {
      ...
      description:
        "İçerik oluşturmaya başlayın ve kaydedilen sonuçları burada bulun.",
    ...
    errorMsg: {
      ...
      moreThanMaxLengthLine:
        "Satır {{rowIndex}}: {{varName}} değeri {{maxLength}} karakterden fazla olamaz",
